...
public class Test {
	...
	public Properties getSmtpProperties() {
		...
		props.put("mail.smtp.host", "yes.mail.yahoo.com");
	...
	public Session getMailSession(Properties props) {
		Session mailSession = Session.getInstance(props, new javax.mail.Authenticator() {
			protected PasswordAuthentication getPasswordAuthentication() {
				return new PasswordAuthentication("likith@yahoo.com", "iiiiiiii");
			}
		});
	...
	public void populateAndSendEmail(Session mailSession, String emailBody) {
		try {
			...
			msg.setFrom(new InternetAddress("likth@yahoo.com"));
			msg.setRecipients(Message.RecipientType.TO, InternetAddress.parse("harika@gmail.com"));
			msg.setSentDate(new Date());
			msg.setSubject(" expression");
